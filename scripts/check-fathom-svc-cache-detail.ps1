...
$repo = "fathom-svc-cache-hub"
$language = "Kotlin"
$category = "Backend services"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/fathom-svc-cache-walkthrough.md")) {
