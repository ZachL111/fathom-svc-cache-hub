...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-svc-cache-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-svc-cache-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom-svc-cache-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-fathom_svc_cache_hub-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
