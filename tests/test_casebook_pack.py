"""Regression checks for the fathom-svc-cache-hub casebook."""
...
from casebook.harness import assert_expected, fathom_svc_cache_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_svc_cache_hub_summary(), assert_expected())
